//
//  GenericUserPropertyUnacknowledgedSetControllerState.swift
//  nRFMeshProvision
//
...
class GenericUserPropertySetUnacknowledgedControllerState: NSObject, GenericModelControllerStateProtocol {
    ...
    func humanReadableName() -> String {
        return "Generic UserProperty Set"
    }
    ...
    func execute() {
        var message: GenericUserPropertySetUnacknowledgedMessage
        if let targetState = targetState {
            message = GenericUserPropertySetUnacknowledgedMessage(withTargetState: targetState)
        } else {
        ...
        target.delegate?.sentGenericUserPropertySetUnacknowledged(destinationAddress);
