...
class GenericMoveSetControllerState: NSObject, GenericModelControllerStateProtocol {
    ...
    func receivedData(incomingData : Data) {
        if incomingData[0] == 0x01 {
            ...
            if let result = networkLayer.incomingPDU(strippedOpcode) {
                ...
                print("ignoring non GenericMoveStatus message")
            }
        }
    }
