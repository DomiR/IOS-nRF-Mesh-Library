        ...
        if var aValue = characteristic.value {
            if aValue[0] == 0x03 {
                ...
                if aValue[1] == 0x03 {
                    ...
                    receivedPublicKeyValue(aValue, isSegmented: false)
                } else {
                    if aValue[1] == 0x09 {
                ...
                receivedSegmentedPublicKeyStart(data: aValue)
                ...
                receivedSegmentedPublicKeyContinuation(data: aValue)
                ...
                receivedSegmentedPublicKeyEnd(data: aValue)
            } else {
