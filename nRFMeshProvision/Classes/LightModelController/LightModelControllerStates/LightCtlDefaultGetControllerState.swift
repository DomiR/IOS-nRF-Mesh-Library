//
//  LightCtlDefaultGetControllerState
//  nRFMeshProvision
//
...
class LightCtlDefaultGetControllerState: NSObject, GenericModelControllerStateProtocol {
    ...
    func humanReadableName() -> String {
        return "Light Ctl Default Get"
    }

    func execute() {
        let message = LightCtlDefaultGetMessage()
        //Send to destination
    ...
    func receivedData(incomingData : Data) {
        if incomingData[0] == 0x01 {
            ...
            if let result = networkLayer.incomingPDU(strippedOpcode) {
                ...
                print("ignoring non LightCtlDefaultStatus message")
            }
        }
    }
