...
class VendorModelUnacknowledgedMessageControllerState: NSObject, GenericModelControllerStateProtocol {
    ...
    target.delegate?.sentVendorModelUnacknowledged(destinationAddress);
