...
public struct LightLightnessDefaultGetMessage {
    var opcode  : Data = Data([0x82, 0x55])
    var payload : Data
    ...
    public func assemblePayload(withMeshState aState: MeshState, toAddress aDestinationAddress: Data) -> [Data]? {
        ...
        print("assemble light lightness default get: \(payload.hexString()) \(opcode.hexString()) to \(aDestinationAddress.hexString())")
