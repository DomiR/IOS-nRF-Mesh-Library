...
public struct LightLightnessDefaultSetMessage {
    var opcode  : Data = Data([0x82, 0x59])
    var payload : Data
    ...
    public func assemblePayload(withMeshState aState: MeshState, toAddress aDestinationAddress: Data) -> [Data]? {
        ...
        print("assemble light lightness default set: \(payload.hexString()) \(opcode.hexString()) to \(aDestinationAddress.hexString())")
