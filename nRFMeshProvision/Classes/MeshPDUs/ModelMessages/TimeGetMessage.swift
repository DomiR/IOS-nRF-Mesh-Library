...
public struct TimeGetMessage {
    var opcode  : Data = Data([0x82, 0x37])
    var payload : Data
    ...
    public func assemblePayload(withMeshState aState: MeshState, toAddress aDestinationAddress: Data) -> [Data]? {
        ...
        print("assemble time get: \(payload.hexString()) \(opcode.hexString()) to \(aDestinationAddress.hexString())")
