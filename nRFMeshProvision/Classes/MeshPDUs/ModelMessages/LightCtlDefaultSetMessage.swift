//
//  LightCtlDefaultSetMessage.swift
//  nRFMeshProvision
//
...
public struct LightCtlDefaultSetMessage {
    var opcode  : Data = Data([0x82, 0x69])
    var payload : Data
    ...
    public func assemblePayload(withMeshState aState: MeshState, toAddress aDestinationAddress: Data) -> [Data]? {
        ...
        print("assemble light ctl default set: \(payload.hexString()) \(opcode.hexString()) to \(aDestinationAddress.hexString())")
