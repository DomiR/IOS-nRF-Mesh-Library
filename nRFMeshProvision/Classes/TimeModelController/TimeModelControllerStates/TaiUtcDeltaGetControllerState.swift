...
class TaiUtcDeltaGetControllerState: NSObject, GenericModelControllerStateProtocol {
    ...
    func humanReadableName() -> String {
        return "Tai Utc Delta Get"
    }

    func execute() {
        let message = TaiUtcDeltaGetMessage()
        //Send to destination
